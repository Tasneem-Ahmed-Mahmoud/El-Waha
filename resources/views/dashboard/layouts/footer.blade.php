...
<footer class="main-footer">
    <strong>حقوق النشر &copy; 2014-2021 <a href="https://www.mp3quran.net/ar/">رابط الموقع</a>.</strong>
    كل الحقوق محفوظة.
...
<!-- Sparkline -->
<script src="{{asset('dashboard/assets')}}/plugins/sparklines/sparkline.min.js"></script>
<!-- JQVMap -->
...
<script src="{{asset('dashboard/assets')}}/plugins/daterangepicker/daterangepicker.min.js"></script>
